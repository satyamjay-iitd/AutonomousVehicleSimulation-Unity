    ...
    public class PinetLd : LaneDetection
    {
        ...
        private void Start()
        {
            var context = new ProcessStartInfo
            {
                ...
                Arguments = "/home/janib/Downloads/Editor/AutonomousDriving-Refactored/Inference_Server/LaneDetectionProcess_PINET.py",
        ...
        private void LateUpdate()
        {
            ...
            {
                SensorStore.LdOutput = JsonConvert.DeserializeObject<PinetLdOutput>(Ipc.ReadPinetOutput());
